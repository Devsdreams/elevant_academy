...
class Crud_model extends CI_Model
{
    ...
    public function add_lesson()
    {
        ...
        if ($lesson_type == 'video') {
            ...
            if ($lesson_provider == 'youtube' || $lesson_provider == 'vimeo') {
                ...
                // Forzar el tipo de video si el proveedor es youtube o vimeo
    ...
    // CRUD operations for elevant_section
    public function add_elevant_section($course_id) {
        $data['title'] = html_escape($this->input->post('title'));
        $data['course_id'] = $course_id;
        $this->db->insert('section', $data);
        $section_id = $this->db->insert_id();
    ...
    public function edit_elevant_section($section_id) {
        $data['title'] = $this->input->post('title');
        $this->db->where('id', $section_id);
        $this->db->update('section', $data);
    }

    public function delete_elevant_section($course_id, $section_id) {
        $this->db->where('id', $section_id);
        $this->db->delete('section');
    ...
    public function get_elevant_section($type_by, $id) {
        $this->db->order_by("order", "asc");
        if ($type_by == 'course') {
            return $this->db->get_where('section', array('course_id' => $id));
        } elseif ($type_by == 'section') {
    ...
    public function serialize_elevant_section($course_id, $serialization) {
        $updater = array(
            'section' => $serialization
        );
        $this->db->where('id', $course_id);
    ...
    public function add_elevant_lesson() {
...
public function edit_elevant_lesson($lesson_id)
{
...
public function delete_elevant_lesson($lesson_id)
{
    $this->db->where('id', $lesson_id);
    $this->db->delete('lesson');
}
