            ...
            <div class="media-body">
              <div class="chart-widget-list">
                ...
                <p>
                  ...
                  <span class="float-right">
                    <?php if (get_settings('purchase_code_status') == 'expired'): ?>
                      <span class="badge badge-danger-lighten float-right mt-1"><?php echo get_phrase(get_setting('purchase_code_status')); ?></span>
                    ...
                    <?php elseif (get_settings('purchase_code_status') == 'valid'): ?>
                      <span class="badge badge-success-lighten"><?php echo get_phrase(get_settings('purchase_code_status')); ?></span>
                    <?php else: ?>
                      <span class="badge badge-danger-lighten"><?php echo get_phrase(get_settings('purchase_code_status')); ?></span>
                    <?php endif; ?>
                  </span>
                </p>
                <p>
                  <i class="mdi mdi-square"></i> <?php echo get_phrase('support_expiry_date'); ?>
                    ...
                    <?php if (get_settings('support_expiry_date') != "invalid"): ?>
                        <span class="float-right"><?php echo get_settings('support_expiry_date'); ?></span>
                    <?php else: ?>
                        <span class="float-right"><span class="badge badge-danger-lighten"><?php echo get_settings('support_expiry_date'); ?></span></span>
                    <?php endif; ?>
                </p>
                <p class="mb-0">
                  <i class="mdi mdi-square"></i> <?php echo get_phrase('customer_name') ?>
                  <?php if (get_settings('customer_name') != "invalid"): ?>
                      <span class="float-right"><?php echo get_settings('customer_name'); ?></span>
                  <?php else: ?>
                      <span class="float-right"><span class="badge badge-danger-lighten"><?php echo get_settings('customer_name'); ?></span></span>
                  <?php endif; ?>
                </p>
                <p style="margin-top: 8px;">
                  <i class="mdi mdi-square"></i> <?php echo get_phrase('get_customer_support'); ?>
                  <span class="float-right"><a href="http://digitaldreams.co" target="_blank" style="color: #343a40;"> <i class="mdi mdi-telegram"></i> <?php echo get_phrase('customer_support'); ?> </a> </span>
                </p>
              </div>
            </div>
